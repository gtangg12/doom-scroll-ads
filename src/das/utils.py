...
def generate_image(prompt: str, model: str = "grok-imagine-v0p9") -> Image.Image:
    ...
    response = requests.post('https://api.x.ai/v1/images/generations', headers=headers, json=data)
